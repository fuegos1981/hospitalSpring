...
public enum MainQuery {
    ...
    GET_ALL_SCHEDULES("from Schedule el"),
    GET_ALL_APPOINTMENTS("from Appointment el"+
            " left join fetch el.patient patient"+
            " left join fetch el.doctor doctor"),
    GET_ALL_CATEGORIES("from Category el"),
    GET_ALL_DIAGNOSISES("from Diagnosis el"),
